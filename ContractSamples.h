...
public:
	...
	static Contract USOptionContractEx(char *pStockName,char *pData,  double strike);
	...
	static Contract OptionForQuery(char *,char *,char *);
	static Contract StockForQuery(char *);
	static Contract StockForQueryNASDAQ(char *pStockName);
	static Contract StockForQueryNYSE(char *pStockName);
	static Contract StockForQueryAMEX(char *pStockName);
	static Contract StockForQueryExchange(char *pStockName, char *pExchange);
