...
Contract ContractSamples::USOptionContract(){
	...
	contract.exchange = "SMART";
	contract.currency = "USD";
	contract.lastTradeDateOrContractMonth = "20220715";
	contract.strike = 2300;
	//contract.right = "PUT";
	contract.right = "CALL";
	contract.multiplier = "100";
	return contract;
...
Contract ContractSamples::USOptionContractEx(char *pStockName, char *pData,double strike)
{
	Contract contract;
	contract.symbol = pStockName;
	contract.secType = "OPT";
	contract.exchange = "SMART";
	contract.currency = "USD";
	contract.lastTradeDateOrContractMonth = pData;
...
Contract ContractSamples::ByConId(){
     ...
     * to prevent abuse.
     */
Contract ContractSamples::OptionForQuery(char *pStockName,char *pDate,char *pCurrency){
	//! [optionforquery]
	Contract contract;
	contract.symbol = pStockName;
	contract.secType = "OPT";
	contract.exchange = "SMART"/*"SEHK"*/;
	contract.currency = pCurrency;
	contract.lastTradeDateOrContractMonth = pDate;
	contract.right = "PUT";
	//! [optionforquery]
	return contract;
}
Contract ContractSamples::StockForQueryNASDAQ(char *pStockName) {
	//! [optionforquery]
	Contract contract;
	contract.symbol = pStockName;
	contract.secType = "STK";
...
Contract ContractSamples::StockForQueryNYSE(char *pStockName) {
	//! [optionforquery]
	Contract contract;
	contract.symbol = pStockName;
	contract.secType = "STK";
...
Contract ContractSamples::StockForQueryAMEX(char *pStockName) {
	//! [optionforquery]
	Contract contract;
	contract.symbol = pStockName;
	contract.secType = "STK";
...
Contract ContractSamples::StockForQueryExchange(char *pStockName,char *pExchange) {
	//! [optionforquery]
	Contract contract;
	contract.symbol = pStockName;
	contract.secType = "STK";
...
Contract ContractSamples::StockForQuery(char *pStockName) {
	//! [optionforquery]
	Contract contract;
	contract.symbol = pStockName;
	contract.secType = "STK";
